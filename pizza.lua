-- updated by ThanhDanh#6446 originally made by demonkjq
-- working as of 1/23/2023
...
creditLbl=Create("TextLabel",main,{Position=UDim2.new(0,0,1,5),Size=UDim2.new(0,100,0,15),BackgroundTransparency=1,TextColor3=Color3.new(1,1,1),Text="by demonkjq",TextScaled=true,TextStrokeTransparency=.8})
